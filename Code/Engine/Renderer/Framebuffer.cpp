...
{
    GLfloat colorData[4];
    Vector4 colorVector = clearColor.ToVec4();
    colorData[0] = colorVector.x;
    colorData[1] = colorVector.y;
    colorData[2] = colorVector.z;
    colorData[3] = colorVector.w;
    glClearBufferfv(GL_COLOR, bufferNumber, colorData);
    GL_CHECK_ERROR();
}
...
{
    Renderer::instance->BindFramebuffer(this);
}
