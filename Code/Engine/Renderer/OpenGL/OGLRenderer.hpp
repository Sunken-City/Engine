...
//-----------------------------------------------------------------------------------
    ...
    #define GL_CHECK_ERROR()  OGLRenderer::GLCheckError(__FILE__, __LINE__);
#else
...
public:
    ...
    //CONSTRUCTORS//////////////////////////////////////////////////////////////////////////
    OGLRenderer(const Vector2Int& windowSize);
    ~OGLRenderer();

    //FUNCTIONS//////////////////////////////////////////////////////////////////////////
    void CreateDefaultResources();
    void ClearScreen(float red, float green, float blue) override;
