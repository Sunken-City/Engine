...
void MemoryOutputWindow::Update(float deltaSeconds)
{
    ...
    if (!m_outputWindow)
    {
        m_outputWindow = new TextBox(Vector3(1300.0f, 500.0f, 0.0f), Vector3::UP, Vector3::RIGHT, 300, 300, 1.0f, BitmapFont::CreateOrGetFontFromGlyphSheet("Runescape"), LEFT_ALIGNED);
    }
